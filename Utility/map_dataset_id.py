...
def map_dataset_to_dataset_id(corpus_dir):
    ...
    if corpus_dir == "VCTK_single_uk_with_us_g2p_mix_emb":
    ...
    elif corpus_dir == "VCTK_single_uk_with_uk_g2p_mix_emb":
    ...
    elif corpus_dir == "VCTK_single_uk_with_us_g2p":
    ...
    elif corpus_dir == "VCTK_single_uk_with_uk_g2p":
