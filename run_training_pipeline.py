...
from TrainingInterfaces.TrainingPipelines.FastSpeech2_IntegrationTest import (
...
from TrainingInterfaces.TrainingPipelines.PortaSpeech_IntegrationTest import (
    run as ps_integration_test,
)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="IMS Speech Synthesis Toolkit - Call to Train"
    )
