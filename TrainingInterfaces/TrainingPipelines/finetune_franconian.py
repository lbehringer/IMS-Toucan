...
def run(
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(
            MODELS_DIR, "PortaSpeech_Franconian_German"
    ...
    german_datasets.append(
        prepare_fastspeech_corpus(
            transcript_dict=build_path_to_transcript_dict_mls_franconian_german(),
            corpus_dir=os.path.join(PREPROCESSING_DIR, "Franconian_German"),
            lang="de",
            ctc_selection=False,
