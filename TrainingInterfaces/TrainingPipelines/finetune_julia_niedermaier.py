...
from TrainingInterfaces.Text_to_Spectrogram.PortaSpeech.portaspeech_train_loop_arbiter import (
    train_loop,
)
...
from Utility.path_to_transcript_dicts import (
    build_path_to_transcript_dict_friedrich,
    build_path_to_transcript_dict_hui_julia_niedermaier,
)
...
def run(
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(
            MODELS_DIR, "PortaSpeech_Austrian_German"
    ...
    german_datasets.append(
        prepare_fastspeech_corpus(
            transcript_dict=build_path_to_transcript_dict_hui_julia_niedermaier(),
            corpus_dir=os.path.join(PREPROCESSING_DIR, "Julia_Niedermaier"),
            lang="de",
        )
    ...
    train_loop(
        ...
        path_to_checkpoint=os.path.join(MODELS_DIR, "PortaSpeech_Meta", "best.pt")
